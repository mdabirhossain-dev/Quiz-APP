//
// 
// FileName: CustomRoundedCorners.swift
// ProjectName: Quiz App
//
// Created by MD ABIR HOSSAIN on 10/8/24 at 11:38 PM
...
struct CustomRoundedCorners: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        let tr = min(min(self.topLeft, h/2), w/2)
        let tl = min(min(self.topRight, h/2), w/2)
